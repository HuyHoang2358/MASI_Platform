...
@section('product-update')
    <form method="POST" action="{{ route('admin.product.update') }}" class="overflow-x-auto flex flex-col mt-2">
        @csrf
        @method('PUT')
                    ...
                    <div>
                        ...
                        <div id="image" class="input-group flex gap-2">
                            ...
                            <input required readonly id="product-thumbnail" class="form-control" type="text"
                                name="product-thumbnail" value={{ $product->images }}>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div id="holder" style="margin-top:15px;">
                        <img width="100" height="100" src="{{ $product->images }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="p-5 flex flex-col gap-2">
                    <div>
                        ...
                        <input required id="product-quantity" name="product-quantity" type="number" class="form-control"
                            placeholder="Nhập tiêu số lượng" value={{ $product->quantity }}>
                    </div>
                    <div>
                        ...
                        <input required id="product-stock" name="product-stock" type="number" class="form-control"
                            placeholder="Nhập lượng tồn kho" value={{ $product->stock }}>
                    </div>
                    <div class="flex flex-row gap-2">
                        <div>
                            ...
                            <input required id="product-price" name="product-price" type="number" class="form-control"
                                placeholder="Nhập giá bán" value={{ $product->price }}>
                        </div>
                        <div>
                            ...
                            <input required id="product-cost" name="product-cost" type="number" class="form-control"
                                placeholder="Nhập giá nhập" value={{ $product->cost }}>
                        </div>
                    </div>
                </div>
            </div>
