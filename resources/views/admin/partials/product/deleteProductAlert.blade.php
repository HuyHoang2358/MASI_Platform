<form method="POST" action="{{ route('admin.product.delete') }}" id="delete-product-form" class="modal" tabindex="-1" aria-hidden="true">
    @csrf
    @method('DELETE')
            ...
            <div class="modal-body p-0">
                <div class="p-5 text-center">
                    ...
                    <div class="text-slate-500 mt-2">
                        Bạn có muốn sản phẩm "<span id="del-product-name"></span>" khỏi bảng ghi? 
                        <br>
