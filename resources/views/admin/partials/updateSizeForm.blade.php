        ...
        <div class="modal-content">
            ...
            <div class="modal-body flex flex-col gap-2">
                ...
                <div class="col-span-12 sm:col-span-6">
                    ...
                    <input id="name" name="name" type="text" class="form-control" placeholder="Nhập tên kích thước">
                </div>
                <div class="grid grid-cols-2 gap-2">
                    <div class="">
                        <label for="weight" class="form-label">Cân nặng</label>
                        <input id="weight" name="weight" type="text" class="form-control" placeholder="Nhập cân nặng">
                    </div>
                    <div class="">
                        <label for="height" class="form-label">Chiều cao</label>
                        <input id="height" name="height" type="text" class="form-control" placeholder="Nhập chiều cao">
                    </div>
                </div>
				<div class="col-span-12 sm:col-span-6">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary w-fit">Xác nhận</button>
            </div>
            <!-- END: Modal Footer -->
        </div>
    </div>
