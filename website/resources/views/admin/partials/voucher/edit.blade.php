...
@section('content')
    <h3 class="px-5 py-3 text-orange-400 text-3xl font-semibold my-3 bg-white rounded-lg">Sửa Voucher</h3>
            ...
            <div class="col-span-1 w-full bg-white rounded-lg p-7">
                ...
                <div class="flex flex-col gap-5 mt-5">
                    <div>
                        ...
                        <input class="w-full bg-gray-100 rounded-md border-gray-400 pl-5" type="text" placeholder="Type name of Voucher" name="name" value="{{$voucher->name}}">
                    </div>
                    <div>
                        ...
                        <input class="w-full bg-gray-100 rounded-md border-gray-400 pl-5" type="text" placeholder="Type code of Voucher" name="code" value="{{$voucher->code}}">
                    </div>
                    <div>
                        ...
                        <input class="w-full bg-[#f7f7f7] rounded-md border-gray-400 pl-5" type="text" placeholder="Private" name="visibility" value="{{$voucher->visibility}}">
                    </div>
                    <div>
                        ...
                        <input class="w-full bg-[#f7f7f7] rounded-md border-gray-400 pl-5" type="text" placeholder="Percent" name="type" value="{{$voucher->type}}">
                    </div>
                    <div>
                        ...
                        <input class="w-full bg-[#f7f7f7] rounded-md border-gray-400 pl-5" type="text" placeholder="Type code of discount amount" name="amount" value="{{$voucher->quantity}}">
                    </div>
                    <div>
                        ...
                        <div class="flex gap-5">
                            <input class="w-full bg-[#f7f7f7] rounded-md border-gray-400 pl-5" type="text" placeholder="Chưa chọn ảnh" name="image" value="{{$voucher->image}}">
            ...
            <div class="col-span-1 w-full bg-white rounded-lg p-7">
                ...
                <div class="flex flex-col gap-5 mt-5">
                    ...
                    <div>
                        ...
                        <input class="w-full bg-[#f7f7f7] rounded-md border-gray-400 pl-5" type="text" name="quantity" value="{{$voucher->quantity}}">
                    </div>
                    <div>
                        <h3 class="font-medium text-base flex items-start">In stock<i class="fa-solid fa-star-of-life text-[8px] text-red-500 m-1"></i></h3>
                        <input class="w-full bg-[#f7f7f7] rounded-md border-gray-400 pl-5" type="text" name="in_stock" value="{{$voucher->in_stock}}">
                    </div>
                    <div>
                    ...
                    <div class="flex gap-4 justify-end">
                        <a href="{{route('voucher.index')}}" class="px-10 py-3 bg-yellow-400 rounded-lg text-white text-base">Cancel </a>
