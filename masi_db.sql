...
CREATE DATABASE IF NOT EXISTS `masi_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `masi_db`;
...
INSERT INTO `admins` (`id`, `name`, `email`, `password`, `remember_token`, `profile_photo_path`, `created_at`, `updated_at`) VALUES
...
-- Dumping data for table masi_db.migrations: ~0 rows (approximately)
...
-- Dumping data for table masi_db.sessions: ~1 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('PPETOIoMcVeSIJrn5yfQgYZpe1ZHdkD8SU62hnSP', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '', 1726592494);
