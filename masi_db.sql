...
-- Dumping data for table masi_db.categories: ~9 rows (approximately)
...
-- Dumping structure for table masi_db.colors
...
-- Dumping data for table masi_db.colors: ~3 rows (approximately)
REPLACE INTO `colors` (`id`, `name`, `icon`, `hex_code`, `description`, `created_at`, `updated_at`) VALUES
	(2, 'dabao', 'http://masiweb.th/storage/photos/UET-logo-txt.png', NULL, 'test', '2024-10-12 14:33:32', '2024-10-12 15:34:55'),
	(3, 'dabao2', NULL, '#b32323', 'test', '2024-10-12 14:40:58', '2024-10-12 15:30:13');
...
-- Dumping data for table masi_db.migrations: ~13 rows (approximately)
REPLACE INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(25, '2024_10_12_153546_create_colors_table', 7);
...
-- Dumping data for table masi_db.seos: ~3 rows (approximately)
...
REPLACE INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('a2ElBuABqu0JeM9Y7MihIolUyTwNhtqLZrDUv2vT', 1, '127.0.0.1', 'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Mobile Safari/537.36 Edg/129.0.0.0', '', 1728758605);
...
-- Dumping data for table masi_db.sizes: ~12 rows (approximately)
